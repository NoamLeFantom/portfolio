...
import styles from "../styles/CablesGLPage.module.scss";
    ...
    <div className={"GlobalPage"}>
      ...
      <main>
        ...
        >
          ...
          <iframe
            className={`${styles.cablesGLIframe}`}
            style={{ border: "0px" }}
            allow="autoplay"
            src="https://cables.gl/view/tvDm1H"
          ></iframe>
        </div>
      </main>
      <Ui_transitionR
        className={"Right yInvert"}
        BackgroundShapeFill={"#EA5930"}
        BackgroundFill={"#EFEFEF"}
      />
      {/* <Footer/> */}
